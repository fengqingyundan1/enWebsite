<template>
  <div>
    ...
    <div class="banner-box">
        <!--video-box start-->
        <div class="video-box">
           <video class="shadow-video" ref="video" :autoplay="videoAutoPlay" v-if="showVideo" style="object-fit: fill" src="https://video.toread.com.cn/%E5%AE%98%E7%BD%91/pc_outgoing6_s.mp4"  controls="controls"  poster="../assets/m_img/m_outgoing1.png" x5-playsinline="" playsinline="true" webkit-playsinline="true" x-webkit-airplay="true" x5-video-player-type="h5" x5-video-player-fullscreen="" x5-video-orientation="portraint">
    ...
    <div class="container m-content-box">
      ...
      <div class="row professional-box">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center no-padding">
          <div class="img-box">
             <img class="professional-img" src="../assets/m_img/m_outgoing_professional.png" alt="">
          </div>
        </div>
      </div>
      <!--Professional end-->
      ...
      <div class="row products-box" @click="goSelect()">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
            <h2 class="title">Enjoy Your Life</h2>
         </div>
